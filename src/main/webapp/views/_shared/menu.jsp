	...
	<div class="container-fluid">  
		...
		<div class="collapse navbar-collapse" >
			<div class="nav navbar-nav col-12 col-sm-1 col-lg-2">
				<a class="navbar-brand" href="/bicomat/compteAgency">Comptes Agency</a>
			</div>
			<div class="col-12 col-sm-1 col-lg-2">
				<a class="navbar-brand" href="/bicomat/comptes">Comptes</a>
			</div>
			<div class="col-12 col-sm-1 col-lg-2">
				<a class="navbar-brand" href="/bicomat/creertiers">Tiers</a>
			</div>
			<div class="col-12 col-sm-1 col-lg-2">
				<a class="navbar-brand" href="/bicomat/deconnexion">Déconnexion</a>
			</div>		
		</div>	
	</div>
</nav>